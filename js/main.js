...
! function (y) {
	...
	CRUMINA.layerInit = function () {
		...
		n.length && n.hasClass("js-fixed-footer") && (n.before('<div class="block-footer-height"></div>'), y(".block-footer-height").matchHeight({
			target: n
		}))
	...
	CRUMINA.counters = function () {
		...
		y(".js-popup-iframe").magnificPopup({
			disableOn: 700,
			type: "iframe",
			mainClass: "mfp-fade",
			removalDelay: 160,
		...
		y(".js-equal-child").find(".theme-module").matchHeight({
			property: "min-height"
		})
	}, CRUMINA.rangeSlider = function () {
		y(".range-slider-js").ionRangeSlider({
			type: "double",
			grid: !0,
			min: 0,
			max: 1e3,
		...
		y(".swiper-container").each(function () {
			var t = y(this),
				...
				i = !1;
			t.addClass("swiper-" + e + " initialized").attr("id", e), t.closest(".crumina-module").find(".swiper-pagination").addClass("pagination-" + e);
			...
			1 < o && (i = {
				...
				onSlideChangeStart: function (e) {
					var i;
					t.closest(".crumina-module").find(".slider-slides").length && (t.closest(".crumina-module").find(".slider-slides .slide-active").removeClass("slide-active"), i = e.slides.eq(e.activeIndex).attr("data-swiper-slide-index"), t.closest(".crumina-module").find(".slider-slides .slides-item").eq(i).addClass("slide-active"))
				}
			}), g++
		...
		var r = document.getElementById("pathD"),
			...
			h = !0;
		m.style.visibility = "visible", f.onclick = function () {
			m.className = "menu-icon-wrapper scaled", h ? (e(d), s(u), e(p)) : (o(d), u.draw(i, n, .7, {
				delay: .1,
				easing: ease.ease("elastic-out", 2, .4)
			}), o(p)), h = !h, setTimeout(function () {
				m.className = "menu-icon-wrapper"
			}, 450)
		}
	}, e.keydown(function (e) {
		27 == e.which && (t.removeClass("overlay-enable"), y(".search-standard").removeClass("open"), l.css({
			visibility: "visible"
		}), y("#menu-icon-trigger").css({
			opacity: "1"
		}), y(".top-bar").removeClass("open"))
		...
		return l.find(".search-standard").addClass("open"), l.css({
			visibility: "hidden"
		}), y("#menu-icon-trigger").css({
			opacity: "0"
		}), setTimeout(function () {
		...
		return l.find(".search-standard").removeClass("open"), l.css({
			visibility: "visible"
		}), y("#menu-icon-trigger").css({
			opacity: "1"
		}), !1
	...
	}), y(".collapse").collapse(), jQuery(".back-to-top").on("click", function () {
		...
		jQuery(function () {
			...
			y(this).closest(".crumina-pricings").find(".price").each(function () {
				e ? y(this).text(y(this).data("annually")) : y(this).text(y(this).data("monthly"))
			})
		}), y("#menu-icon-wrapper").length && CRUMINA.burgerAnimation(), l.crumegamenu({
			showSpeed: 0,
			hideSpeed: 0,
			trigger: "hover",
			animation: "drop-up",
		...
		}), CRUMINA.fixedHeader(), CRUMINA.initSwiper(), CRUMINA.equalHeight(), CRUMINA.mediaPopups(), CRUMINA.IsotopeSort(), CRUMINA.parallaxFooter(), CRUMINA.rangeSlider(), CRUMINA.cruminaSelect(), CRUMINA.languageSelect(), CRUMINA.layerInit(), CRUMINA.countdown(), CRUMINA.counters(), CRUMINA.progresBars(), CRUMINA.formValidate()
